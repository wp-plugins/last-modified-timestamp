...
This plugin adds the information to the admin interface about when each post/page was last modified. 
...
No options currently available, simply activate and enjoy!
...
Email your questions to `evanmattson` *at* `gmail` *dot* `com`
